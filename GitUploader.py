...
# ( o.o )  🔓 Not licensed.
#  > ^ <   ⚠️ Владелец heta.hikariatama.ru не несет никакой ответственности за этот скрипт
# ---------------------------------------------------------------------------------
# Name: GitUploader
            ...
            if r.status_code == 201:
                ...
                await utils.answer(
                    ...
                    (
                        ...
                        f" href='{uploaded_to}'>репозиторий!</a>\n\nПрямая ссылка:"
                        f" <a href='{uploaded_to_raw}'>{uploaded_to_raw}</a>"
                    ),
                )
