...
class Aeconv(loader.Module):
    ...
    strings = {
        ...
        "no_args": (
            "<emoji document_id=5343820329980535275>🖕</emoji> <b>Where are the"
            " arguments?</b>"
        ),
        "unsupported": (
            "<emoji document_id=5307761055873638139>🚫</emoji> <b>Unsupported"
            " currency!</b>"
        ),
        "converted": (
            "<emoji document_id=6037400506823871682>💸</emoji> <b>Converted"
            " <code>{}</code></b>\n\n"
        ),
        "already": (
            "<emoji document_id=5348177037431414677>⚠️</emoji> <b>Wait until the bot"
            " responds!</b>"
        ),
        "wrong_currency": (
            "<emoji document_id=5345937796102104039>🤷‍♀️</emoji><b> Wrong currency</b>"
        ),
    ...
    strings_ru = {
        "wait": (
            "<emoji document_id=5346192260029489215>💵</emoji> <b>Конвертирую...</b>"
        ),
        "no_args": (
            "<emoji document_id=5343820329980535275>🖕</emoji> <b>Где аргументы?</b>"
        ),
        "unsupported": (
            "<emoji document_id=5307761055873638139>🚫</emoji> <b>Валюта не"
            " поддерживается!</b>"
        ),
        "converted": (
            "<emoji document_id=6037400506823871682>💸</emoji> <b>Сконвертирован"
            " <code>{}</code></b>\n\n"
        ),
        "already": (
            "<emoji document_id=5348177037431414677>⚠️</emoji> <b>Подожди пока бот"
            " ответит!</b>"
        ),
        "wrong_currency": (
            "<emoji document_id=5345937796102104039>🤷‍♀️</emoji><b> Неправильная"
            " валюта</b>"
        ),
    ...
    strings_uz = {
        "wait": (
            "<emoji document_id=5346192260029489215>💵</emoji> <b>Valyuta"
            " konvertatsiyasi...</b>"
        ),
        "no_args": (
            "<emoji document_id=5343820329980535275>🖕</emoji> <b>Argumetlar"
            " qayerda?</b>"
        ),
        "unsupported": (
            "<emoji document_id=5307761055873638139>🚫</emoji> <b>Valyuta"
            " qo'llab-quvvatlanmaydi!</b>"
        ),
        "converted": (
            "<emoji document_id=6037400506823871682>💸</emoji> <b>Konvertatsiya qilindi"
            " <code>{}</code></b>\n\n"
        ),
        "already": (
            "<emoji document_id=5348177037431414677>⚠️</emoji> <b>Bot javob berishini"
            " kuting!</b>"
        ),
        "wrong_currency": (
            "<emoji document_id=5345937796102104039>🤷‍♀️</emoji><b> Noto'g'ri"
            " valyuta</b>"
        ),
    ...
    strings_de = {  # i'm really sorry for translations, i'm not good at it
        "wait": (
            "<emoji document_id=5346192260029489215>💵</emoji> <b>Konvertiere...</b>"
        ),
        "no_args": (
            "<emoji document_id=5343820329980535275>🖕</emoji> <b>Wo sind die"
            " Argumente?</b>"
        ),
        "unsupported": (
            "<emoji document_id=5307761055873638139>🚫</emoji> <b>Nicht unterstützte"
            " Währung!</b>"
        ),
        "converted": (
            "<emoji document_id=6037400506823871682>💸</emoji> <b>Konvertiert"
            " <code>{}</code></b>\n\n"
        ),
        "already": (
            "<emoji document_id=5348177037431414677>⚠️</emoji> <b>Warten Sie, bis der"
            " Bot antwortet!</b>"
        ),
        "wrong_currency": (
            "<emoji document_id=5345937796102104039>🤷‍♀️</emoji><b> Falsche Währung</b>"
        ),
    ...
    strings_tr = {  # i'm really sorry for translations, i'm not good at it
        "wait": (
            "<emoji document_id=5346192260029489215>💵</emoji> <b>Dönüştürülüyor...</b>"
        ),
        "no_args": (
            "<emoji document_id=5343820329980535275>🖕</emoji> <b>Argümanlar nerede?</b>"
        ),
        "unsupported": (
            "<emoji document_id=5307761055873638139>🚫</emoji> <b>Desteklenmeyen para"
            " birimi!</b>"
        ),
        "converted": (
            "<emoji document_id=6037400506823871682>💸</emoji> <b>Dönüştürüldü"
            " <code>{}</code></b>\n\n"
        ),
        "already": (
            "<emoji document_id=5348177037431414677>⚠️</emoji> <b>Bot cevap verene"
            " kadar bekleyin!</b>"
        ),
        "wrong_currency": (
            "<emoji document_id=5345937796102104039>🤷‍♀️</emoji><b> Yanlış para"
            " birimi</b>"
        ),
    ...
    strings_kk = {  # i'm really sorry for translations, i'm not good at it
        "wait": (
            "<emoji document_id=5346192260029489215>💵</emoji> <b>Валюта"
            " айырбасталуда...</b>"
        ),
        "no_args": (
            "<emoji document_id=5343820329980535275>🖕</emoji> <b>Аргументтер қайда?</b>"
        ),
        "unsupported": (
            "<emoji document_id=5307761055873638139>🚫</emoji> <b>Валюта қолдау"
            " көрсетілмейді!</b>"
        ),
        "converted": (
            "<emoji document_id=6037400506823871682>💸</emoji> <b>Айырбасталды"
            " <code>{}</code></b>\n\n"
        ),
        "already": (
            "<emoji document_id=5348177037431414677>⚠️</emoji> <b>Бот жауап бергенге"
            " дейін күтіңіз!</b>"
        ),
        "wrong_currency": (
            "<emoji document_id=5345937796102104039>🤷‍♀️</emoji><b> Дұрыс валюта"
            " емес</b>"
        ),
        ...
        try:
            async with message.client.conversation(self.bot) as conv:
                msg = (
                    ...
                    else await conv.send_message(ex_)
                )
                r = await conv.get_response()
                res = r.text
                text_ = ""
                ...
                if match := re.findall(r"(.*) BTC", res):
                    text_ += (
                        f"\n<b>{self.custom_emojis['bit']} BTC:</b>"
                        f" <code>{match[0]}</code>\n"
                    )
                if match := re.findall(r"(.*) ETH", res):
                    text_ += (
                        f"<b>{self.custom_emojis['eth']} ETH:</b>"
                        f" <code>{match[0]}</code>\n"
                    )

                if ex_ := await self.get_ton_in_rub(
                    args.split(" ")[0], args.split(" ")[1].lower(), True
                ):
                    text_ += (
                        f"<b>{self.custom_emojis['ton']} TON:</b>"
                        f" <code>{ex_.split(' = ')[1]}</code>\n"
                    )
    ...
    @loader.command(
        ru_doc="[валюта] | без аргументов покажет список валют для включения/выключения"
    )
    async def controlvalute(self, message: Message):
        ...
        if args := utils.get_args_raw(message):
            await utils.answer(
                message,
                self.strings["choose_currency"],
                reply_markup=self.currencies_markup(args),
            )
        else:
            return await utils.answer(
                message,
                self.strings["choose_currency"],
                reply_markup=self.currencies_markup(),
            )
